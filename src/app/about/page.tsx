          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">
                We create software solutions using new technologies for both
              ...
              <p className="text-gray-600 mb-6">
                ...
                advancements. We specialize in AI/ML, Web Development, IoT,
              ...
              <ul className="space-y-4 mb-6">
                <li className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-600">
                    ...
                    lasting performance improvements, while also building a
                    great company that attracts, develops, and retains
                    exceptional people.
                  </p>
                </li>
                <li className="flex items-start space-x-3">
              ...
              <p className="text-gray-600">
                ...
                we have developed applications that are now being used by
                millions of consumers worldwide. We pride ourselves on
                understanding how to build successful software products that not
                only meet our clients&apos; needs but also exceed their
                expectations. Our team&apos;s expertise and commitment to
                quality enable us to deliver reliable and scalable solutions to
